...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  Widget clipShape() {
    return Stack(
      children: <Widget>[
        Text("Registro PASO 1:"),
        Text("Rellena con tus datos para crear tu perfil.")
      ],
    );
  }
...
//        height: _height / 20,
        ...
        child: Text('Registrarme', style: TextStyle(fontSize: _large? 14: (_medium? 12: 10)),),
      ),
    );
  }
  ...
  Widget infoTextRow() {
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          Text(
            "O crea tu cuenta con redes sociales",
            style: TextStyle(fontWeight: FontWeight.w400, fontSize: _large? 12: (_medium? 11: 10)),
          ),
        ],
      ),
